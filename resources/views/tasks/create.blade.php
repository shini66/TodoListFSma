<x-app-layout>
    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <h2 class="mt-4 text-3xl font-bold tracking-tight">Nueva Tarea</h2>
            <p class="mt-1 text-gray-600">Creá una nueva tarea y asignala a un manager.</p>
            ...
            <div class="mt-6 max-w-lg rounded-lg bg-white p-6 shadow-sm">
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <x-input id="title" class="mt-1 block w-full" type="text" name="title" :value="old('title')" required autofocus />
